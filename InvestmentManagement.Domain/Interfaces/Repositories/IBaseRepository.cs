...
namespace InvestmentManagement.Domain.Interfaces.Repositories
{
    public interface IBaseRepository<T> where T : class
    {
        ...
        Task<List<T>> ListPaginationAsync<K>(Expression<Func<T, K>> sortExpression, int page, int quantity);
